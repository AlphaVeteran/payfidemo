...
## Conflux Hackfest 2026

**Cross-Space PoC Validation (Core -> eSpace)**

We successfully validated the end-to-end flow from Core-side order deposit to automatic escrow creation on eSpace:
