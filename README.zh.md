...
此外，**买家使用人民币（CNY）付款**在跨境场景中常遇阻力：境外商户多以外币标价结算，直接人民币通道有限，买家往往依赖卡组织或聚合支付，面临**汇兑与手续费不透明、到账慢**，且**付款与收货、争议处理节奏**难以与境外侧对齐。

**方案要点：**（一）**合规分层**——在岸资金不出境，离岸结算在 **eSpace** 完成，在岸意向与承诺落在 **Core**。（二）**无托管风险**——保证金锁在**合约**里，任一方无法单独划走。（三）**发挥 Conflux 能力**——**Gas 赞助**降低用户门槛；**双空间（Core + eSpace）**让在岸/离岸逻辑天然分离。
